...
export const DessertsProvider = ({ children }) => {
  const [myDessertList, setMyDessertList] = useState([
    {
      image: {
  ...
  const handleAddToCart = (dessert) => {
    setCartList((prevList) => {
      const existingDessert = prevList.find(
      ...
      if (existingDessert) {
        ...
        return [...prevList, { ...dessert, quantity: 1 }];
      }
    });

    setTotalPrice((prevTotal) => prevTotal + dessert.price);
  };
